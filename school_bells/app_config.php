<?php
	...
	//schema details
		...
		$y++;
		$apps[$x]['db'][$y]['table']['name'] = "v_school_bell_active";
		$apps[$x]['db'][$y]['table']['parent'] = "";
		$z = 0;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "domain_uuid";
		$apps[$x]['db'][$y]['fields'][$z]['type']['pgsql'] = "uuid";
		...
		$apps[$x]['db'][$y]['fields'][$z]['type']['sqlite'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['type']['mysql'] = "char(36)";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "The call UUID of the playing call";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "target_extensions";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "playback_file";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
		$z++;
